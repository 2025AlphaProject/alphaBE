...
from .views import MissionListView, MissionCheckCompleteView, MissionImageUploadView, RandomMissionCreateView
...
urlpatterns = [
    ...
    path('mission/random/',RandomMissionCreateView.as_view({
        'post': 'create',
